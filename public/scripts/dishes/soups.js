const list = {
  ...
  peaSoup: [
    ...
    "Boil the peas for 20 minutes, then add the potatoes. Meanwhile fry the onions and sausage. Add the fried foodstuffs into the boiling soup base and simmer for 5 more minutes.",
    "images/peaSoup.jpg",
  ],
};
export default list;
