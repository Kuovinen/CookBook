const list = {
  ...
  friedChicken: [
    ...
    [
      [4, "pieces", "chicken thighs", 0],
      [2, "cups", "buttermilk", 0],
      [1, "cup", "all-purpose flour", 0],
      [1, "teaspn", "salt", 0],
      [1, "teaspn", "black pepper", 0],
      [1, "teaspn", "paprika", 0],
      [0.5, "teaspn", "garlic powder", 0],
      [0.5, "teaspn", "onion powder", 0],
      [1, "cup", "vegetable oil", 0],
    ],
    "Marinate chicken thighs in buttermilk for at least 1 hour (or overnight for extra tenderness). In a separate bowl, mix flour, salt, pepper, paprika, garlic powder, and onion powder. Heat vegetable oil in a pan to 180°C. Remove chicken from buttermilk, coat evenly with seasoned flour, and fry for 6-8 minutes per side until golden brown. Drain on paper towels and serve hot.",
    "images/fried_chicken.jpeg",
  ],
};
export default list;
